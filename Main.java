public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Tests:
        System.out.println("Task 3: решить выражение a * (b + (c / d)); 5 * (6 + (7 / 9)) =  "+ task3_expressionSolver(5, 6, 7, 9));
        System.out.println();

        System.out.println("Task 4: проверить, что сумма от 10 до 20. 3+12 "+ task4_isSummFrom10To20(3, 12));
        System.out.println("Task 4: проверить, что сумма от 10 до 20 5+4 "+ task4_isSummFrom10To20(5, 4));
        System.out.println();

        System.out.println("Task 5: положительное или отрицательное? 10: ");
        task5_isPosiriveOrNegative(10);
        System.out.println("Task 5: положительное или отрицательное? -10: ");
        task5_isPosiriveOrNegative(-10);
        System.out.println();
    ...
    public static float task3_expressionSolver(int a, int b, int c, int d){
    ...
    public static boolean task4_isSummFrom10To20(int a, int b){
    ...
    public static void task5_isPosiriveOrNegative(int i) {
    ...
    public static void task7_hello(String name){
